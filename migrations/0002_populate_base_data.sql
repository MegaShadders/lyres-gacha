...
INSERT INTO missions (id, description, reward, currency_id)
SELECT 
  json_extract(value, '$.id'), 
...
FROM json_each('[
    {"id":1,"description":"Daily Login:","reward":1600,"currency_id":1},
    {"id":2,"description":"Daily Login:","reward":160,"currency_id":2}
]');
